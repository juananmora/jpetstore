node('java-docker-slave') {
	...
	stage ('Upload Artifact') {
	   nexusPublisher nexusInstanceId: 'nexus3', nexusRepositoryId: 'maven-snapshots', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: 'target/jpetstore.war']], mavenCoordinate: [artifactId: 'jpetstore', groupId: 'org.jenkins-ci.release', packaging: 'war', version: 'release']]]
	}
